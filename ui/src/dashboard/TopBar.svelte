...
<header class="relative z-10 h-16 w-full items-center md:h-20">
	<!-- <div class="relative mx-auto flex h-full flex-col justify-center px-3">
		<div class="lg:max-w-68 relative flex w-full items-center pl-1 sm:ml-0 sm:pr-2">
			<div class="container relative left-0 flex h-auto h-full w-3/4">
				...
				<div class="group relative hidden h-full w-full items-center md:flex lg:w-64">
					<div
					...
					<input
						type="text"
						class="block w-full rounded-2xl bg-gray-100 py-1.5 pl-10 pr-4 leading-normal text-gray-400 ring-opacity-90 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
						placeholder="Search"
					/>
					<div
			...
			>
				<span class="block pr-1 text-gray-700">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						class="h-6 w-6"
						viewBox="0 0 20 20"
				...
				<span class="relative block inline-block rounded px-3 py-2 text-gray-700">
					<span>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="h-6 w-6"
				...
				<span class="relative block pl-5">
					<img
						alt="Dave Glad"
						src="/images/1.jpg"
